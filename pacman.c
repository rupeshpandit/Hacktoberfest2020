...
*   @author Matheus Barcellos Cunha (https://github.com/matheushw)
*   SIMPLE PACMAN with a crappy (or non existing) interface.
*	Uses wavefront algorithm.
*   Helps to see how the wavefront works.
*	The documentation is in Portuguese.
*	To compile and run:
*	gcc pacman.c -g -Wall -o pacman && ./pacman
*	You can change the size of the matrix in line 20.
*	The enemy default position is (0, 0). To change it, go to line 265 and 266.
*	Then, you need to put where you wanna start in the matrix.
*	Play and learn :)
* 	
*/
...
#define MAXN 10 //change here for a larger or smaller grid
